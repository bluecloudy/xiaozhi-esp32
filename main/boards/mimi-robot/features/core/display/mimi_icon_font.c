 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --no-compress --stride 1 --align 1 --font fontawesome-webfont.ttf --range 61744,61633,61480 --format lvgl -o MIMI_ICON_FONT.c
 ******************************************************************************/
...
#ifndef ENABLE_MIMI_ICON_FONT
#define ENABLE_MIMI_ICON_FONT 1
#endif

#if ENABLE_MIMI_ICON_FONT
...
#if LVGL_VERSION_MAJOR >= 8
static const lv_font_fmt_txt_dsc_t mimi_icon_font_dsc = {
#else
static lv_font_fmt_txt_dsc_t mimi_icon_font_dsc = {
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t MIMI_ICON_FONT = {
#else
lv_font_t MIMI_ICON_FONT = {
#endif
...
#endif
    .dsc = &mimi_icon_font_dsc, /*The custom font data. Will be accessed by `get_glyph_bitmap/dsc` */
...
#endif /*#if ENABLE_MIMI_ICON_FONT*/
