...
// Application-level reconfiguration for media features.
// It directly reconfigures the underlying I2S TX channel. Note that some dedicated 
// I2C audio codecs may also require I2C clock commands, but this covers standard I2S.
bool AudioCodec::SetOutputSampleRate(int sample_rate) {
    ...
    } else if (original_output_sample_rate_ == 0 && output_sample_rate_ > 0) {
        // Save initial rate
